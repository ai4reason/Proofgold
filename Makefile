...
bin/proofgoldclibc: bin/zarithint.cmo bin/json.cmo bin/config.cmo bin/hashaux.cmo bin/sha256.cmo bin/ripemd160.cmo bin/version.cmo bin/utils.cmo bin/ser.cmo bin/hash.cmo bin/htree.cmo bin/db.cmo bin/logic.cmo bin/mathdata.cmo bin/checking.cmo bin/assets.cmo bin/tx.cmo bin/ctre.cmo bin/ctregraft.cmo bin/secp256k1.cmo bin/cryptocurr.cmo bin/signat.cmo bin/script.cmo bin/block.cmo bin/net.cmo bin/ltcrpc.cmo bin/blocktree.cmo bin/setconfig.cmo bin/commands.cmo bin/inputdraft.cmo bin/staking.cmo
	$(OCAMLC) -I bin -I +threads -I +zarith -o bin/proofgoldclibc unix.cma threads.cma zarith.cma zarithint.cmo json.cmo config.cmo version.cmo utils.cmo ser.cmo hashaux.cmo sha256.cmo ripemd160.cmo hash.cmo htree.cmo db.cmo net.cmo secp256k1.cmo cryptocurr.cmo signat.cmo ltcrpc.cmo script.cmo logic.cmo mathdata.cmo checking.cmo assets.cmo tx.cmo ctre.cmo setconfig.cmo proofgoldcli.cmo
...
bin/sha256.cmi: src/sha256.mli bin/ser.cmi bin/zarithint.cmi
	$(OCAMLC) -I bin -I +zarith -I +threads -o bin/sha256.cmi -c src/sha256.mli
...
bin/block.cmi: src/block.mli bin/hash.cmi bin/logic.cmi bin/mathdata.cmi bin/checking.cmi bin/assets.cmi bin/signat.cmi bin/tx.cmi bin/ctre.cmi bin/ctregraft.cmi bin/db.cmi bin/zarithint.cmi
...
bin/setconfig.cmi: src/setconfig.mli bin/json.cmi
	$(OCAMLC) -I bin -o bin/setconfig.cmi -c src/setconfig.mli

bin/commands.cmi: src/commands.mli bin/ctre.cmi bin/json.cmi bin/zarithint.cmi
...
bin/staking.cmi: src/staking.mli bin/hash.cmi bin/mathdata.cmi bin/assets.cmi
...
bin/ser.cmx: src/ser.ml bin/ser.cmi bin/zarithint.cmx
	$(OCAMLOPT) $(OCAMLOPTARGS) -I bin -I +zarith -o bin/ser.cmx -c src/ser.ml

bin/secp256k1.cmx: src/secp256k1.ml bin/secp256k1.cmi bin/zarithint.cmx
	$(OCAMLOPT) $(OCAMLOPTARGS) -I bin -I +zarith -o bin/secp256k1.cmx -c src/secp256k1.ml
...
bin/cryptocurr.cmx: src/cryptocurr.ml bin/cryptocurr.cmi bin/ser.cmx bin/hashaux.cmx bin/sha256.cmx bin/hash.cmx bin/secp256k1.cmx bin/config.cmx bin/json.cmx bin/zarithint.cmx
	$(OCAMLOPT) $(OCAMLOPTARGS) -I bin -I +zarith -o bin/cryptocurr.cmx -c src/cryptocurr.ml
...
bin/script.cmx: src/script.ml bin/script.cmi bin/cryptocurr.cmx bin/secp256k1.cmx bin/hash.cmx bin/ripemd160.cmx bin/sha256.cmx bin/signat.cmx bin/json.cmx bin/ltcrpc.cmx
	$(OCAMLOPT) $(OCAMLOPTARGS) -I bin -I +zarith -o bin/script.cmx -c src/script.ml
...
bin/hashaux.cmx: src/hashaux.ml bin/hashaux.cmi bin/zarithint.cmx
	$(OCAMLOPT) $(OCAMLOPTARGS) -I bin -I +zarith -o bin/hashaux.cmx -c src/hashaux.ml

bin/sha256.cmx: src/sha256.ml bin/sha256.cmi bin/hashaux.cmx bin/ser.cmx bin/utils.cmx bin/zarithint.cmx
	$(OCAMLOPT) $(OCAMLOPTARGS) -I bin -I +threads -I +zarith -o bin/sha256.cmx -c src/sha256.ml

bin/ripemd160.cmx: src/ripemd160.ml bin/ripemd160.cmi bin/hashaux.cmx
	$(OCAMLOPT) $(OCAMLOPTARGS) -I bin -I +threads -o bin/ripemd160.cmx -c src/ripemd160.ml

bin/hash.cmx: src/hash.ml bin/hash.cmi bin/hashaux.cmx bin/sha256.cmx bin/ripemd160.cmx bin/ser.cmx bin/json.cmx bin/zarithint.cmx
	$(OCAMLOPT) $(OCAMLOPTARGS) -I bin -I +threads -I +zarith -o bin/hash.cmx -c src/hash.ml
...
bin/checking.cmx: src/checking.ml bin/checking.cmi bin/logic.cmx bin/mathdata.cmx bin/htree.cmx bin/hash.cmx bin/ser.cmx bin/zarithint.cmx
	$(OCAMLOPT) $(OCAMLOPTARGS) -I bin -I +zarith -o bin/checking.cmx -c src/checking.ml
...
bin/ctre.cmx: src/ctre.ml bin/ctre.cmi bin/hash.cmx bin/logic.cmx bin/mathdata.cmx bin/checking.cmx bin/assets.cmx bin/tx.cmx bin/ser.cmx bin/config.cmx bin/db.cmx bin/net.cmx bin/json.cmx bin/zarithint.cmx
	$(OCAMLOPT) $(OCAMLOPTARGS) -I bin -I +zarith -o bin/ctre.cmx -c src/ctre.ml
...
bin/blocktree.cmx: src/blocktree.ml bin/blocktree.cmi bin/ser.cmx bin/hash.cmx bin/version.cmx bin/utils.cmx bin/db.cmx bin/assets.cmx bin/signat.cmx bin/tx.cmx bin/ctre.cmx bin/block.cmx bin/net.cmx bin/ltcrpc.cmx bin/mathdata.cmx bin/zarithint.cmx
	$(OCAMLOPT) $(OCAMLOPTARGS) -I bin -I +threads -I +zarith -o bin/blocktree.cmx -c src/blocktree.ml

bin/setconfig.cmx: src/setconfig.ml bin/setconfig.cmi bin/config.cmx bin/json.cmx
	$(OCAMLOPT) $(OCAMLOPTARGS) -I bin -o bin/setconfig.cmx -c src/setconfig.ml

bin/commands.cmx: src/commands.ml bin/commands.cmi bin/config.cmx bin/ser.cmx bin/hash.cmx bin/signat.cmx bin/net.cmx bin/ctre.cmx bin/cryptocurr.cmx bin/ctre.cmx bin/blocktree.cmx bin/json.cmx bin/zarithint.cmx
	$(OCAMLOPT) $(OCAMLOPTARGS) -I bin -I +threads -I +zarith -o bin/commands.cmx -c src/commands.ml
...
bin/staking.cmx: src/staking.ml bin/staking.cmi bin/config.cmx bin/ser.cmx bin/hash.cmx bin/signat.cmx bin/net.cmx bin/ctre.cmx bin/secp256k1.cmx bin/cryptocurr.cmx bin/block.cmx bin/blocktree.cmx bin/json.cmx bin/zarithint.cmx
	$(OCAMLOPT) $(OCAMLOPTARGS) -I bin -I +threads -I +zarith -o bin/staking.cmx -c src/staking.ml
...
bin/proofgold.cmx: src/proofgold.ml bin/assets.cmx bin/tx.cmx bin/ctre.cmx bin/block.cmx bin/version.cmx bin/utils.cmx bin/net.cmx bin/setconfig.cmx bin/commands.cmx bin/inputdraft.cmx bin/staking.cmx bin/db.cmx bin/blocktree.cmx bin/ltcrpc.cmx bin/zarithint.cmx
	$(OCAMLOPT) $(OCAMLOPTARGS) -I bin -I +threads -I +zarith -o bin/proofgold.cmx -c src/proofgold.ml
...
bin/secp256k1.cmo: src/secp256k1.ml bin/secp256k1.cmi bin/zarithint.cmo
...
bin/cryptocurr.cmo: src/cryptocurr.ml bin/cryptocurr.cmi bin/ser.cmo bin/hashaux.cmo bin/sha256.cmo bin/hash.cmo bin/secp256k1.cmo bin/config.cmo bin/json.cmo bin/zarithint.cmo
	$(OCAMLC) -I bin -I +threads -I +zarith -o bin/cryptocurr.cmo -c src/cryptocurr.ml
...
bin/script.cmo: src/script.ml bin/script.cmi bin/cryptocurr.cmo bin/secp256k1.cmo bin/hash.cmo bin/ripemd160.cmo bin/sha256.cmo bin/signat.cmo bin/json.cmo bin/zarithint.cmo bin/ltcrpc.cmo
...
bin/hash.cmo: src/hash.ml bin/hash.cmi bin/hashaux.cmo bin/sha256.cmo bin/ripemd160.cmo bin/ser.cmo bin/json.cmo bin/zarithint.cmo
	$(OCAMLC) -I bin -I +threads -I +zarith -o bin/hash.cmo -c src/hash.ml
...
bin/block.cmo: src/block.ml bin/block.cmi bin/hash.cmo bin/logic.cmo bin/mathdata.cmo bin/checking.cmo bin/assets.cmo bin/signat.cmo bin/tx.cmo bin/ctre.cmo bin/ctregraft.cmo bin/db.cmo bin/net.cmo bin/zarithint.cmo
	$(OCAMLC) -I bin -I +threads -I +zarith -o bin/block.cmo -c src/block.ml
...
bin/blocktree.cmo: src/blocktree.ml bin/blocktree.cmi bin/ser.cmo bin/hash.cmo bin/version.cmo bin/utils.cmo bin/db.cmo bin/assets.cmo bin/signat.cmo bin/tx.cmo bin/ctre.cmo bin/block.cmo bin/net.cmo bin/ltcrpc.cmo bin/mathdata.cmo bin/zarithint.cmo
	$(OCAMLC) -I bin -I +threads -I +zarith -o bin/blocktree.cmo -c src/blocktree.ml

bin/setconfig.cmo: src/setconfig.ml bin/setconfig.cmi bin/config.cmo bin/json.cmo
	$(OCAMLC) -I bin -o bin/setconfig.cmo -c src/setconfig.ml

bin/commands.cmo: src/commands.ml bin/commands.cmi bin/config.cmo bin/ser.cmo bin/hash.cmo bin/signat.cmo bin/net.cmo bin/ctre.cmo bin/cryptocurr.cmo bin/ctre.cmo bin/blocktree.cmo bin/json.cmo bin/zarithint.cmo
	$(OCAMLC) -I bin -I +threads -I +zarith -o bin/commands.cmo -c src/commands.ml
...
bin/staking.cmo: src/staking.ml bin/staking.cmi bin/config.cmo bin/ser.cmo bin/hash.cmo bin/signat.cmo bin/net.cmo bin/ctre.cmo bin/secp256k1.cmo bin/cryptocurr.cmo bin/block.cmo bin/blocktree.cmo bin/json.cmo bin/zarithint.cmo
	$(OCAMLC) -I bin -I +threads -I +zarith -o bin/staking.cmo -c src/staking.ml
...
bin/proofgold.cmo: src/proofgold.ml bin/assets.cmo bin/tx.cmo bin/ctre.cmo bin/block.cmo bin/version.cmo bin/utils.cmo bin/net.cmo bin/setconfig.cmo bin/commands.cmo bin/inputdraft.cmo bin/staking.cmo bin/db.cmo bin/blocktree.cmo bin/ltcrpc.cmo bin/zarithint.cmo
	$(OCAMLC) -I bin -I +threads -I +zarith -o bin/proofgold.cmo -c src/proofgold.ml
