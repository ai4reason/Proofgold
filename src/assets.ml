...
let json_preasset u =
  ...
  | OwnsObj(h,beta,None) -> JsonObj([("type",JsonStr("preasset"));("preassettype",JsonStr("ownsobj"));("objid",JsonStr(hashval_hexstring h));("objaddr",JsonStr(Cryptocurr.addr_pfgaddrstr (termaddr_addr (hashval_md160 h))));("owneraddress",JsonStr(addr_pfgaddrstr (payaddr_addr beta)))])
  | OwnsObj(h,beta,Some(r)) -> JsonObj([("type",JsonStr("preasset"));("preassettype",JsonStr("ownsobj"));("objid",JsonStr(hashval_hexstring h));("objaddr",JsonStr(Cryptocurr.addr_pfgaddrstr (termaddr_addr (hashval_md160 h))));("owneraddress",JsonStr(addr_pfgaddrstr (payaddr_addr beta)));("royalty",json_atoms r)])
  | OwnsProp(h,beta,None) -> JsonObj([("type",JsonStr("preasset"));("preassettype",JsonStr("ownsprop"));("propid",JsonStr(hashval_hexstring h));("propaddr",JsonStr(Cryptocurr.addr_pfgaddrstr (termaddr_addr (hashval_md160 h))));("owneraddress",JsonStr(addr_pfgaddrstr (payaddr_addr beta)))])
  | OwnsProp(h,beta,Some(r)) -> JsonObj([("type",JsonStr("preasset"));("preassettype",JsonStr("ownsprop"));("propid",JsonStr(hashval_hexstring h));("propaddr",JsonStr(Cryptocurr.addr_pfgaddrstr (termaddr_addr (hashval_md160 h))));("owneraddress",JsonStr(addr_pfgaddrstr (payaddr_addr beta)));("royalty",json_atoms r)])
  | OwnsNegProp -> JsonObj([("type",JsonStr("preasset"));("preassettype",JsonStr("ownsnegprop"))])
  | RightsObj(h,r) -> JsonObj([("type",JsonStr("preasset"));("preassettype",JsonStr("rightsobj"));("objid",JsonStr(hashval_hexstring h));("objaddr",JsonStr(Cryptocurr.addr_pfgaddrstr (termaddr_addr (hashval_md160 h))));("units",JsonNum(Int64.to_string r))])
  | RightsProp(h,r) -> JsonObj([("type",JsonStr("preasset"));("preassettype",JsonStr("rightsprop"));("propid",JsonStr(hashval_hexstring h));("propaddr",JsonStr(Cryptocurr.addr_pfgaddrstr (termaddr_addr (hashval_md160 h))));("units",JsonNum(Int64.to_string r))])
